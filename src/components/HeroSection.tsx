  ...
  return (
    <section className="relative min-h-screen bg-gradient-hero overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 left-10 w-32 h-32 border-4 border-copper/20 rounded-full animate-float" />
        <div className="absolute top-40 right-20 w-24 h-24 border-4 border-copper/30 rounded-full animate-float" style={{ animationDelay: "2s" }} />
        <div className="absolute bottom-40 left-1/4 w-16 h-16 bg-copper/10 rounded-full animate-float" style={{ animationDelay: "1s" }} />
        <div className="absolute top-1/3 right-1/3 w-2 h-40 bg-gradient-to-b from-copper/40 to-transparent rotate-45" />
      ...
      <div className="relative z-10 container mx-auto px-4 pt-32 pb-20 min-h-screen flex flex-col justify-center">
        <div className="max-w-4xl">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-copper/20 backdrop-blur-sm border border-copper/30 rounded-full px-4 py-2 mb-8">
            <Zap className="w-4 h-4 text-copper" />
            <span className="text-copper text-sm font-medium">Licensed & Certified Professionals</span>
          </div>

          {/* Main Heading */}
          <h1 className="font-display text-5xl md:text-7xl lg:text-8xl text-primary-foreground leading-tight mb-6">
            TSHIFHIWA
            <span className="block text-gradient-copper">PLUMBING &</span>
          ...
          <div className="flex flex-wrap gap-4 mb-16">
            <Button variant="copper" size="xl" onClick={scrollToBooking}>
              <Phone className="w-5 h-5" />
              Book a Service
            </Button>
            <Button variant="outlineCopper" size="xl" onClick={scrollToServices}>
          ...
          <div className="grid grid-cols-3 gap-8 max-w-xl">
            <div className="text-center">
              <div className="font-display text-4xl md:text-5xl text-copper mb-1">15+</div>
              <div className="text-primary-foreground/60 text-sm uppercase tracking-wider">Years Experience</div>
            </div>
            <div className="text-center">
              <div className="font-display text-4xl md:text-5xl text-copper mb-1">2K+</div>
              <div className="text-primary-foreground/60 text-sm uppercase tracking-wider">Projects Done</div>
            </div>
            <div className="text-center">
              <div className="font-display text-4xl md:text-5xl text-copper mb-1">24/7</div>
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 animate-bounce">
          <ArrowDown className="w-6 h-6 text-copper" />
        </div>
      </div>

      {/* Side Icons */}
      <div className="absolute right-8 top-1/2 -translate-y-1/2 hidden lg:flex flex-col gap-6">
        <div className="w-16 h-16 rounded-full bg-copper/20 backdrop-blur-sm flex items-center justify-center animate-pulse-glow">
