import { Wrench, Zap, Phone, Mail, MapPin } from "lucide-react";
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 rounded-lg bg-copper flex items-center justify-center">
                <Wrench className="w-6 h-6 text-secondary-foreground" />
              </div>
              <div>
                <h3 className="font-display text-xl text-primary-foreground">TSHIFHIWA</h3>
                <p className="text-copper text-sm font-display">PLUMBING & ELECTRICAL</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              <a 
                href="#" 
                className="w-10 h-10 rounded-full bg-primary-foreground/10 flex items-center justify-center hover:bg-copper transition-colors duration-300 group"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <button onClick={() => scrollToSection("services")} className="text-primary-foreground/60 hover:text-copper transition-colors">
                  Our Services
                </button>
              </li>
              <li>
                <button onClick={() => scrollToSection("booking")} className="text-primary-foreground/60 hover:text-copper transition-colors">
                  Book a Service
                </button>
              </li>
              <li>
                <a href="tel:+27123456789" className="text-primary-foreground/60 hover:text-copper transition-colors">
                  Emergency Contact
                </a>
              </li>
            </ul>
