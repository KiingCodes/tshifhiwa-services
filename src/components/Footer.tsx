        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          <div className="lg:col-span-2">
            <div className="mb-4">
              ...
              <p className="text-green text-sm font-display">
                PLUMBING & ELECTRICAL
              </p>
            </div>
            <p className="text-primary-foreground/60 max-w-md leading-relaxed mb-6">
              Your trusted partner for all plumbing and electrical needs.
              Professional, reliable, and committed to excellence in every
            ...
            <div className="flex gap-4">
              ...
              >
                <svg
                  className="w-5 h-5 text-primary-foreground group-hover:text-secondary-foreground transition-colors"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            <ul className="space-y-3">
              <li>
                <button
                  ...
                  className="text-primary-foreground/60 hover:text-green transition-colors"
                >
                  Our Services
                </button>
              </li>
